...
创建一个新文件夹，并将 [docker-compose.yml](https://github.com/oiov/Mail1s.net/blob/main/docker-compose.yml) 和 [.env](https://github.com/oiov/Mail1s.net/blob/main/.env.example) 文件复制到该文件夹中。

> 或者只创建一个 [docker-compose.yml](https://github.com/oiov/Mail1s.net/blob/main/docker-compose.yml) 文件，将其中的 `${DATABASE_URL}` 等变量替换为你的数据库连接地址等信息。
...
```bash
docker pull ghcr.io/oiov/Mail1s.net/wrdo:latest
```

在 [container/Mail1s.net](https://github.com/oiov/Mail1s.net/pkgs/container/Mail1s.net%2Fwrdo) 可以找到官方镜像。
