...
> Or only create a [docker-compose.yml](https://github.com/oiov/Mail1s.net/blob/main/docker-compose.yml) file, just replace `${DATABASE_URL}` with your database connection url and so on.
...
Find the official image here: [container/Mail1s.net](https://github.com/oiov/Mail1s.net/pkgs/container/Mail1s.net%2Fwrdo)
