...
Mail1s.net now supports multiple cloud storage providers:
...
[
  {
    "AllowedOrigins": [
      "http://localhost:3000",
      "https://Mail1s.net" // Replace with your domain
    ],
    "AllowedMethods": [
      "GET",
      "PUT",
