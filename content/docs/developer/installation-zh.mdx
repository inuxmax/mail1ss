---
title: 开发手册
description: 简单介绍 Mail1s.net 部署所需的环境变量
---
...
<Callout type="info" twClass="mt-4">
  ...
  或参考社区优秀部署文档：
    ...
    - https://bravexist.cn/2025/06/Mail1s.net.html
...
```bash
npx create-next-app wrdo --example "https://github.com/oiov/Mail1s.net"
```

或者使用 Vercel 部署：

[![使用 Vercel 部署](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Foiov%2FMail1s.net)
...
| NEXT_PUBLIC_APP_NAME              | `Mail1s.net`                                           | 网站名称。                                                             |
