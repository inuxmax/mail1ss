---
title: Open API
description: Some open APIs for Mail1s.net. It's free and unlimited to use!
---
...
Mail1s.net provides two simple and easy-to-use APIs for scraping website data:
...
- [Icon Api](/docs/open-api/icon)
- [Temp Gmail Api](/docs/open-api/temp-gmail)
